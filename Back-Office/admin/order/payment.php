...
tr:nth-child(even){background-color: #f2fcf9}
...
<?php
	...
	$strSQL = "SELECT * FROM orderlist WHERE status='2'";
...
<h2>สินค้าที่ชำระเงินแล้ว</h2>

<hr class="line">

<a class="button" style="vertical-align:middle" href="report.php"><img src = "img/download.png" width="20" height="20" ><span>&nbsp;ออก Excel</span></a>

<table>
  <tr>
    <th width="10%">รหัสการจอง</th>
    <th width="9%">วันที่สั่งจอง</th>
    <th width="10%">รหัสสมาชิก</th>
    <th width="30%">รายการ</th>
    <th width="11%">จำนวน</th>
    <th width="6%">ราคา</th>
